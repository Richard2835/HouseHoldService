...
public class DatabaseHealthCheck extends HealthCheck {
    ...
    protected Result check() throws Exception {
        ...
        houseHold2.setCity("Bratislava");
        houseHold2.setState("Slovakia");
        houseHold2.setStreet("Krížna");
        houseHold2.setZip("12345");
        houseHold2.setContactPerson(
                new ContactPerson("Mirko", "Janáš",
                        "0903123456", "m.janas@fri.uniza.sk"));
        ...
        IotNode iotnode1 = new IotNode();
        iotnode1.setName("weather station 1");
        iotnode1.setHouseHold(houseHold);

        IotNode iotnode2 = new IotNode();
        iotnode2.setName("weather station 2");
        iotnode2.setHouseHold(houseHold2);

        iotNodeDAO.create(iotnode1);
        iotNodeDAO.create(iotnode2);
